                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="store_name" value="{{ $settings['store_name'] ?? 'TechnoStore' }}"
                                       class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="TechnoStore">
                            ...
                            <div>
                                ...
                                <input type="text" name="store_tagline" value="{{ $settings['store_tagline'] ?? '' }}"
                                       class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="Toko Komputer Terpercaya">
                            </div>
                        </div>
                        <div>
                            ...
                            <textarea name="store_description" rows="2"
                                      class="w-full px-4 py-2.5 rounded-xl text-sm resize-none bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500"
                    ...
                    <div class="grid gap-4">
                        <div>
                            ...
                            <input type="text" name="store_address" value="{{ $settings['store_address'] ?? '' }}"
                                   class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="Jl. Sudirman No.1, Jakarta Pusat">
                        </div>
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="store_phone" value="{{ $settings['store_phone'] ?? '' }}"
                                       class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="0812-0000-0001">
                            </div>
                            <div>
                                ...
                                <input type="email" name="store_email" value="{{ $settings['store_email'] ?? '' }}"
                                       class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="info@toko.com">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="hero_badge" value="{{ $settings['hero_badge'] ?? '' }}"
                                   class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="Stok Tersedia — Pengiriman Seluruh Indonesia">
                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="hero_title" value="{{ $settings['hero_title'] ?? '' }}"
                                       class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="Toko Komputer">
                            </div>
                            <div>
                                ...
                                <input type="text" name="hero_title_highlight" value="{{ $settings['hero_title_highlight'] ?? '' }}"
                                       class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="Terpercaya #1">
                            </div>
                        </div>
                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="hero_cta_primary" value="{{ $settings['hero_cta_primary'] ?? '' }}"
                                       class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="🛍️ Belanja Sekarang">
                            </div>
                            <div>
                                ...
                                <input type="text" name="hero_cta_secondary" value="{{ $settings['hero_cta_secondary'] ?? '' }}"
                                       class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="Lihat Kategori">
                            </div>
                        </div>
        ...
        <div x-show="activeTab === 'stats'">
            <div class="glass rounded-2xl p-6 border border-slate-200 dark:border-white/5">
                ...
                <div class="grid gap-6">
                    @foreach([1, 2, 3] as $i)
                    <div class="p-4 rounded-xl border border-slate-200 dark:border-white/5 bg-slate-50 dark:bg-slate-800">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="stat_{{ $i }}_value" value="{{ $settings['stat_'.$i.'_value'] ?? '' }}"
                                       class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="500+">
                            </div>
                            <div>
                                ...
                                <input type="text" name="stat_{{ $i }}_label" value="{{ $settings['stat_'.$i.'_label'] ?? '' }}"
                                       class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="Produk">
                            </div>
                        </div>
                    </div>
                    @endforeach
                ...
                <div class="grid gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="promo_badge" value="{{ $settings['promo_badge'] ?? '' }}"
                               class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="⚡ Penawaran Spesial">
                    </div>
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="promo_title" value="{{ $settings['promo_title'] ?? '' }}"
                                   class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="Diskon hingga">
                        </div>
                        <div>
                            ...
                            <input type="text" name="promo_highlight" value="{{ $settings['promo_highlight'] ?? '' }}"
                                   class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="30%">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="promo_subtitle" value="{{ $settings['promo_subtitle'] ?? '' }}"
                               class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="untuk produk pilihan kategori Laptop & PC Gaming">
                    </div>
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="promo_cta" value="{{ $settings['promo_cta'] ?? '' }}"
                                   class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="Cek Sekarang →">
                        </div>
                        <div>
                            ...
                            <input type="text" name="promo_link_slug" value="{{ $settings['promo_link_slug'] ?? '' }}"
                                   class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="laptop">
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="why_us_title" value="{{ $settings['why_us_title'] ?? '' }}"
                                   class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="Mengapa">
                        </div>
                        <div>
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" name="feature_{{ $i }}_icon" value="{{ $settings['feature_'.$i.'_icon'] ?? '' }}"
                                       class="w-full px-4 py-2.5 rounded-xl text-sm text-center text-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="🛡️">
                            </div>
                            <div class="col-span-2">
                                ...
                                <input type="text" name="feature_{{ $i }}_title" value="{{ $settings['feature_'.$i.'_title'] ?? '' }}"
                                       class="w-full px-4 py-2.5 rounded-xl text-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white focus:outline-none focus:border-blue-500" placeholder="Produk Original">
                            </div>
                        </div>
                        <div>
