...
<div class="flex items-center gap-3 mb-6">
    ...
    <h1 class="text-slate-900 dark:text-white font-jakarta font-bold text-2xl">Tambah Kategori</h1>
</div>
...
<form action="{{ route('admin.categories.store') }}" method="POST">
    ...
    <div class="glass rounded-2xl p-6 border border-slate-200 dark:border-white/5 max-w-2xl">
        <div class="space-y-4">
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" required
                       class="w-full px-4 py-3 text-sm placeholder-slate-500" placeholder="Laptop">
            ...
            <div>
                ...
                <input type="text" name="icon" value="{{ old('icon', '💻') }}" required
                       class="w-full px-4 py-3 text-sm placeholder-slate-500" placeholder="💻">
                <p class="text-xs text-slate-500 mt-1">Gunakan emoji untuk ikon kategori.</p>
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="w-full px-4 py-3 text-sm placeholder-slate-500" placeholder="Deskripsi kategori...">{{ old('description') }}</textarea>
            </div>
                ...
                <div>
                    ...
                    <div class="pt-3">
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="is_active" value="1" class="accent-blue-500 w-4 h-4" {{ old('is_active', true) ? 'checked' : '' }}>
        ...
        <div class="mt-6 pt-6 border-t border-slate-200 dark:border-white/5 flex gap-3">
            <button type="submit" class="btn-glow text-slate-900 dark:text-white font-bold px-8 py-3 rounded-xl">Simpan Kategori</button>
