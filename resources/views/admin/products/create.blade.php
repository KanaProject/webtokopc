...
<div class="flex items-center gap-3 mb-6">
    ...
    <h1 class="text-slate-900 dark:text-white font-jakarta font-bold text-2xl">Tambah Produk</h1>
</div>
...
<form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mt-6 flex gap-3">
        <button type="submit" class="btn-glow text-slate-900 dark:text-white font-bold px-8 py-3 rounded-xl">Simpan Produk</button>
