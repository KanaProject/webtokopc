    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center max-w-4xl mx-auto">
            ...
            <h1 class="font-jakarta text-5xl md:text-7xl font-extrabold text-slate-900 dark:text-white mb-6 leading-tight">
                Toko Komputer
                <br>
                <span class="gradient-text">Terpercaya #1</span>
            </h1>

            <p class="text-slate-500 dark:text-slate-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
                Temukan laptop, PC gaming, monitor, dan aksesoris komputer terbaik dengan harga kompetitif. Produk original bergaransi resmi.
            </p>
            ...
            <div class="grid grid-cols-3 gap-6 mt-16 max-w-xl mx-auto">
                <div class="glass rounded-2xl p-4 text-center">
                    ...
                    <div class="text-slate-500 dark:text-slate-400 text-xs mt-1">Produk</div>
                </div>
                <div class="glass rounded-2xl p-4 text-center">
                    <div class="text-2xl font-bold gradient-text">10K+</div>
                    <div class="text-slate-500 dark:text-slate-400 text-xs mt-1">Pelanggan</div>
                </div>
                <div class="glass rounded-2xl p-4 text-center">
                    <div class="text-2xl font-bold gradient-text">4.9★</div>
                    <div class="text-slate-500 dark:text-slate-400 text-xs mt-1">Rating</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative overflow-hidden rounded-3xl p-8 md:p-12" style="background: linear-gradient(135deg, #1e3a8a 0%, #1e1b4b 50%, #0f172a 100%);">
            ...
            <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                <div>
                    <div class="text-blue-300 text-sm font-semibold mb-2 tracking-widest uppercase">⚡ Penawaran Spesial</div>
                    <h2 class="font-jakarta text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white mb-3">
                        Diskon hingga <span class="text-yellow-400">30%</span>
                    </h2>
                    <p class="text-blue-200 text-lg">untuk produk pilihan kategori Laptop & PC Gaming</p>
                </div>
                <div class="flex-shrink-0">
                    <a href="{{ route('categories.show', 'laptop') }}" class="btn-glow text-slate-900 dark:text-white font-bold px-8 py-4 rounded-2xl text-lg inline-block">
                        Cek Sekarang →
                    </a>
                </div>
            </div>
...
<section class="py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="font-jakarta text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-3">Mengapa <span class="gradient-text">TechnoStore?</span></h2>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            @php
            $features = [
                ['icon' => '🛡️', 'title' => 'Produk Original', 'desc' => 'Semua produk 100% original dengan garansi resmi dari distributor.'],
                ['icon' => '🚀', 'title' => 'Pengiriman Cepat', 'desc' => 'Pengiriman ke seluruh Indonesia dengan kurir terpercaya.'],
                ['icon' => '💳', 'title' => 'Pembayaran Aman', 'desc' => 'Berbagai metode pembayaran tersedia dan 100% aman.'],
                ['icon' => '🔧', 'title' => 'Garansi Servis', 'desc' => 'Layanan purna jual dan garansi servis oleh teknisi berpengalaman.'],
                ['icon' => '💬', 'title' => 'Support 24/7', 'desc' => 'Tim customer service siap membantu Anda kapan saja.'],
                ['icon' => '🏷️', 'title' => 'Harga Terbaik', 'desc' => 'Harga kompetitif dengan kualitas yang tidak perlu diragukan lagi.'],
            ];
            @endphp
